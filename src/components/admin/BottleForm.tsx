...
import { uploadBottleImage } from "@/lib/bottles";
...
/**
 * Add / edit a bottle. Each bottle is independent: its own photo and its own
 * sizes. To use a different bottle for a size, add it as a separate bottle.
 */
  ...
  return (
    ...
    >
      ...
      <p className="mt-1 text-sm text-ink/50">
        Each bottle has its own photo and its own sizes. If a size uses a
        different bottle, add it as a separate bottle.
      </p>
      ...
      <div className="mt-4 grid gap-5 lg:grid-cols-2">
        ...
        <div className="space-y-4">
          ...
          {/* Photo */}
          <div>
            <label className="label">Bottle photo</label>
            <input
              type="file"
              accept="image/*"
          ...
          {/* Sizes */}
          <div>
            <label className="label">Sizes (ml)</label>
